<?php
include('viewteams.php');

if(isset($_POST['delete_teams_btn']))
{
    $del_id=$_POST['del_teams_id'];
     ...
     <!-- Success Modal -->
        <div class="modal fade" id="modaldelsuccess" tabindex="-1" role="dialog" aria-labelledby="successModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                  ...
                  <div class="modal-header">
                      <h5 class="modal-title" id="delModalCenterTitle">Teams Deleted Success</h5>
                  ...
                  <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-outline-primary" onclick="location.href = 'viewteams.php'";>OKay</button>
                  </div>
                  </div>
              </div>
        </div>
        ...
        <div class="modal fade" id="modaldelfailure" tabindex="-1" role="dialog" aria-labelledby="successModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title" id="delModalCenterTitle">Teams Deletion Failure</h5>
                      <button type="button" class="btn btn-outline-dark" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                      </button>
                  </div>
